...
//writeln((i),'  ',round(j));
//if (round(ux)=round(x)) and (round(uy)=round(y)) then
 // Dec(u.heal);
case map[j,i] of
...
public
x,y,dx,dy,ddy,ldx:real;
w,h,n,g,heal,maxheal:integer;
